...
There is no problem with generating and storing all the possible rows in the memory for a given size but when it comes to solving... <br>
...
# To do <br>
Change the solve function in file solve.c so that it no longer becomes a bottleneck.
